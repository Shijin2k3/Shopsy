...
const Services = () => {
  ...
  return (
    <div id="services" className='w-full lg:px-20 px-5 pt[0px] pb-[80px] 
    grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-10'>
      ...
      <div data-aos="zoom-in" data-aos-delay='150' className='flex
      flex-col justify-center items-center gap-2'>
      ...
      <div data-aos="zoom-in" data-aos-delay='250' className='flex
      flex-col justify-center items-center gap-2'>
        <img src={gift} alt="" className='mb-[20px]  w-[60px]'/>
        <h1 className='text-xl text-black font-semibold'>Shop more For Exciting Gifts</h1>
        <p className='text-[17px] text-gray-500'>Lorem ipsum dolor sit amet.</p>
      </div>
    </div>
  )
