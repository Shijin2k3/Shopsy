...
const Reviews = () => {
  ...
  return (
    <div id='testimonials' className='w-full lg:px-20 px-5 py-[80px]
      bg-gray-300 flex flex-col justify-center items-center gap-4'>
        <h1 data-aos="zoom-in" data-aos-delay='100' className='text-purple-600
         text-xl font-semibold capitalize'>1200+ Customer Reviews</h1>
         <h1 data-aos="zoom-in" data-aos-delay='150' className='text-black 
